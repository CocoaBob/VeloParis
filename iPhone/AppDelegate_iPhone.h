...
@interface AppDelegate_iPhone : NSObject <UIApplicationDelegate,CLLocationManagerDelegate,UISearchBarDelegate ,UITableViewDelegate,UITableViewDataSource> {
	UIWindow						*window;
	...
	NSInteger						mOperationsCountForMap;
	NSInteger						mOperationsCountForTable;
}
